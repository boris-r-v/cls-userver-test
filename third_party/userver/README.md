...
|------------------------|-----|-----|
| Core: | [![CI](https://github.com/userver-framework/cls/actions/workflows/ci.yml/badge.svg) ![Docker build](https://github.com/userver-framework/cls/actions/workflows/docker.yaml/badge.svg)](https://github.com/userver-framework/cls/) | [[➚]](https://github.com/userver-framework/cls/tree/v1.0.x) |
